...
export const submissionLifecycleDataSchema = z
  .object({
    ...
    deadline: jsonDateTimeSchema.optional(),
    initiatedAt: jsonDateTimeSchema.optional(),
    retryInitiatedAt: jsonDateTimeSchema.optional(),
    failedAt: jsonDateTimeSchema.optional(),
    cancelledAt: jsonDateTimeSchema.optional(),
    pipelineCancelled: z.boolean().optional(),
    referenceNumber: z.string().optional(),
    previousStatus: submissionStatusSchema.optional(),
    error: z.string().optional(),
    lastError: z.string().optional(),
    lastErrorAt: jsonDateTimeSchema.optional(),
...
export type SubmissionLifecycleData = z.infer<typeof submissionLifecycleDataSchema>;
